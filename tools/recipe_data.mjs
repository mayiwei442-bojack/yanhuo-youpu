...
export const chinese = [
  c("番茄炒蛋", "Tomato and Egg Stir-fry", "家常菜", "鸡蛋3个；番茄2个约400克；小葱1根；盐3克；白糖3克；食用油25毫升", "1）鸡蛋加少许盐打散，热锅多油炒至刚凝固后盛出。2）原锅下番茄炒软出汁，加盐和糖。3）倒回鸡蛋快速翻匀，撒葱花出锅。", "01-fanqie-chaodan.png"),
  c("宫保鸡丁", "Kung Pao Chicken", "川菜", "鸡腿肉300克；花生米50克；干辣椒8个；花椒1茶匙；葱姜蒜各适量；生抽15毫升；香醋15毫升；糖10克；淀粉8克", "1）鸡肉切丁，用生抽和淀粉腌10分钟。2）调匀生抽、醋、糖和少量水。3）炒香辣椒花椒及葱姜蒜，下鸡丁炒熟，倒汁收浓，最后拌入花生。", "02-gongbao-jiding.png"),
  c("麻婆豆腐", "Mapo Tofu", "川菜", "嫩豆腐450克；牛肉末100克；郫县豆瓣酱20克；豆豉8克；花椒粉2克；蒜末10克；高汤200毫升；淀粉8克；青蒜适量", "1）豆腐切块，用淡盐水焯1分钟。2）炒香牛肉末、豆瓣酱、豆豉和蒜末，加高汤。3）下豆腐小火煨5分钟，分两次勾薄芡，撒花椒粉和青蒜。", "03-mapo-doufu.png"),
  c("鱼香肉丝", "Fish-fragrant Shredded Pork", "川菜", "猪里脊250克；木耳40克；胡萝卜80克；青椒80克；泡椒20克；葱姜蒜适量；生抽15毫升；香醋15毫升；糖12克；淀粉10克", "1）肉丝用生抽和淀粉腌10分钟，蔬菜切丝。2）肉丝滑炒变色盛出。3）炒香泡椒和葱姜蒜，下蔬菜、肉丝，倒入醋糖生抽调成的鱼香汁，快速收汁。", "04-yuxiang-rousi.png"),
  c("青椒肉丝", "Shredded Pork with Green Pepper", "家常菜", "猪里脊250克；青椒200克；姜蒜适量；生抽15毫升；料酒10毫升；淀粉8克；盐2克；食用油20毫升", "1）肉切丝，用生抽、料酒和淀粉腌10分钟。2）青椒切丝，干锅炒至略软盛出。3）热油滑熟肉丝，加姜蒜和青椒，大火翻匀调盐。", "05-qingjiao-rousi.png"),
  c("红烧肉", "Red-braised Pork Belly", "江浙菜", "五花肉600克；冰糖25克；生抽25毫升；老抽8毫升；料酒30毫升；姜20克；八角2个；香叶2片；热水适量", "1）五花肉切块焯水沥干。2）小火炒糖色，放肉翻匀，加酱油、料酒和香料。3）加热水没过，小火炖60分钟，开盖收至油亮。", "06-hongshao-rou.png"),
  c("糖醋里脊", "Sweet and Sour Pork Tenderloin", "鲁菜/家常", "猪里脊350克；鸡蛋1个；淀粉80克；番茄酱45克；白醋25毫升；糖35克；盐2克；白芝麻适量", "1）里脊切条，加盐和蛋液，裹淀粉。2）六成热油炸熟，升温复炸至脆。3）锅中熬匀番茄酱、糖、醋和少量水，倒入里脊快速挂汁。", "07-tangcu-liji.png"),
  c("扬州炒饭", "Yangzhou Fried Rice", "淮扬菜", "隔夜米饭500克；鸡蛋2个；虾仁100克；火腿60克；胡萝卜50克；青豆50克；葱花适量；盐3克；白胡椒少许", "1）虾仁焯熟，配料切小丁。2）鸡蛋炒散，下米饭大火炒至颗粒分明。3）加入虾仁、火腿、胡萝卜和青豆炒透，调盐和白胡椒，撒葱花。", "08-yangzhou-chaofan.png"),
  c("清蒸鲈鱼", "Steamed Sea Bass", "粤菜", "鲈鱼1条约600克；姜20克；葱30克；蒸鱼豉油30毫升；料酒10毫升；食用油20毫升", "1）鱼处理干净，两面划刀，放姜片和料酒。2）水开后大火蒸8–10分钟，关火焖2分钟。3）倒去盘中水，铺葱丝，淋豉油，再浇热油。", "09-qingzheng-luyu.png"),
  ...
  c("桂林米粉", "Guilin Rice Noodles", "广西", "干米粉250克；卤牛肉150克；酸豆角60克；花生30克；卤水200毫升；高汤400毫升；葱花和辣椒油适量", "1）米粉泡软煮熟，冲洗沥水。2）碗中放米粉，加入卤水和少量高汤拌匀。3）铺卤牛肉、酸豆角、花生和葱花，按口味加辣椒油。", "11-guilin-mifen.png", CN_HOME),
  ...
  c("干煸四季豆", "Dry-fried Green Beans", "川菜", "四季豆450克；盐1/2茶匙；食用油2汤匙；猪肉末1/4杯；大蒜2瓣；干辣椒2个；碎米芽菜2汤匙；绍兴酒1茶匙；生抽1又1/2茶匙；白糖1/8茶匙；芝麻油1茶匙", "1）炒锅高火预热至刚开始冒烟，放入四季豆和盐，立即转中小火，偶尔翻动约20分钟，至表面出现焦斑并完全熟透，盛出备用。2）锅中加入食用油，中高火把猪肉末炒至褐色熟透；加入切碎的大蒜和干辣椒翻炒30秒，再放碎米芽菜炒1分钟。3）倒回四季豆，加入绍兴酒、生抽、白糖和芝麻油，转高火翻炒1分钟后立即装盘。", "39-ganbian-sijidou.png"),
...
export const western = [
  ...
  w("凯撒沙拉", "Caesar Salad", "美式/意式", "罗马生菜300克；鸡胸肉250克；面包丁80克；帕玛森40克；蛋黄酱40克；柠檬汁15毫升；蒜末5克；凤尾鱼2条；橄榄油20毫升", "1）鸡胸调味煎熟静置切片，面包丁烤脆。2）蛋黄酱、柠檬汁、蒜、凤尾鱼和橄榄油调酱。3）生菜与酱轻拌，铺鸡肉、面包丁和帕玛森。", "19-caesar-salad.png"),
  ...
  w("法式洋葱汤", "French Onion Soup", "法国", "黄洋葱600克；黄油35克；面粉10克；牛高汤900毫升；白葡萄酒100毫升；法棍4片；格鲁耶尔芝士120克；百里香适量", "1）黄油中小火慢炒洋葱35–45分钟至深焦糖色。2）加面粉和白酒，倒高汤与百里香煮20分钟。3）盛入耐热碗，放法棍和芝士，烤至金黄起泡。", "21-french-onion-soup.png"),
  ...
  w("意式培根蛋面", "Spaghetti Carbonara", "意大利", "意大利面250克；意式腌猪颊肉120克；鸡蛋2个；蛋黄2个；佩科里诺芝士80克；黑胡椒2克", "1）猪颊肉小火煎至酥香，保留油脂。2）鸡蛋、蛋黄、芝士和黑胡椒拌匀。3）面煮好与猪颊肉离火拌匀，分次加面汤乳化，避免蛋液凝块。", "56-spaghetti-carbonara.png"),
  w("千层面", "Lasagna", "意大利", "千层面片9张；牛肉末350克；番茄酱500克；洋葱100克；白酱400克；马苏里拉180克；帕玛森50克", "1）炒香洋葱牛肉，加入番茄酱炖20分钟。2）烤盘依次铺肉酱、面片、白酱和芝士，重复三层。3）190℃烤35–40分钟，静置10分钟再切。", "57-lasagna.png"),
  ...
  w("牧羊人派", "Shepherd's Pie", "英国", "羊肉末400克；洋葱100克；胡萝卜120克；豌豆80克；番茄膏20克；高汤250毫升；土豆600克；黄油40克；牛奶80毫升", "1）炒香羊肉末和蔬菜，加番茄膏与高汤炖至浓稠。2）土豆煮软，压成黄油牛奶薯泥。3）肉馅铺烤盘，盖薯泥划纹，200℃烤25分钟至金黄。", "65-shepherds-pie.png"),
