...
export const chinese = [
  ...
  c("锅包肉", "Northeastern Sweet-and-sour Pork", "东北菜", "猪里脊500克；淀粉300克；胡萝卜5克；葱姜蒜适量；香菜3克；白糖30克；白醋10毫升；酱油3毫升；盐4克；清水适量；食用油适量", "1）里脊切成约2–3毫米厚的大片，加少许盐；淀粉分次加水调成能均匀挂住肉片的稠糊。胡萝卜、葱姜切丝，蒜切片，香菜切段。2）油温五至六成热时逐片下肉，中火炸熟捞出；升高油温后回锅快速复炸至外壳焦脆，沥油。3）白糖、白醋、酱油、盐和少量清水调成糖醋汁。4）锅留少许底油，大火炒香配菜丝，放入炸好的肉片，淋入糖醋汁快速翻匀，关火后放香菜出锅。", "34-guobaorou.png"),
  ...
  c("蒜蓉粉丝蒸扇贝", "Steamed Scallops with Garlic Vermicelli", "粤菜", "扇贝6只；粉丝30克；大蒜30克；姜片10克；红尖椒1个；料酒10毫升；生抽20毫升；白糖3克；芝麻香油10毫升；白胡椒粉少许；食用油35毫升", "1）打开扇贝取肉，去除肠脏并冲洗干净，贝壳刷洗擦干；粉丝剪段后用温水泡软、沥干，以少许芝麻香油和白胡椒粉拌匀，分放在贝壳中，再摆上扇贝肉。2）锅中用少量油爆香姜片，转小火加入料酒、生抽、白糖、芝麻香油、白胡椒粉和少许水煮匀，取出姜片。3）蒜蓉分成两半，一半用六成热油炸至金黄，再与生蒜蓉、红椒碎拌成金银蒜，铺在扇贝上并淋调味汁。4）蒸锅水开后大火蒸5–6分钟；出锅后淋上烧至七成热的剩余食用油。", "37-suanrong-fensi-zheng-shanbei.png"),
  ...
  c("干煸四季豆", "Dry-fried Green Beans", "川菜", "四季豆450克；盐1/2茶匙；食用油适量；猪肉末适量；大蒜2瓣，拍碎粗切；干辣椒2个，去籽切碎；碎米芽菜2汤匙；绍兴酒1茶匙；生抽1又1/2茶匙；白糖1/8茶匙；芝麻油适量", "1）此步不放油。炒锅以高火预热至刚开始冒烟，放入450克四季豆和1/2茶匙盐，立即转中小火；偶尔翻动，干煸约20分钟，至四季豆表面出现小焦斑、变软且充分加热至熟，盛出备用。2）四季豆盛出后，锅中加入适量食用油，以中高火将适量猪肉末炒至褐色；依次加入拍碎粗切的大蒜和去籽切碎的干辣椒，翻炒30秒，再加入2汤匙碎米芽菜，继续炒1分钟。3）倒回四季豆，依次加入1茶匙绍兴酒、1又1/2茶匙生抽、1/8茶匙白糖和适量芝麻油；转高火翻炒1分钟，立即装盘。", "39-ganbian-sijidou.png"),
  ...
  c("莲藕排骨汤", "Lotus Root Pork Rib Soup", "湖北", "排骨400克；莲藕600克；姜2片；小葱10克；料酒适量；盐10克；清水适量", "1）排骨剁块，冷水下锅并加适量料酒，煮开焯去血沫，捞出冲洗干净；莲藕刮去外皮后切稍大的滚刀块。2）排骨、莲藕和姜片放入深汤锅，加水没过食材约8厘米，大火煮开后转小火，炖至排骨略松脱、筷子能轻松戳透莲藕。3）起锅前加盐调味，撒葱花即可。", "46-lianou-paigu-tang.png", CN_HOME),
