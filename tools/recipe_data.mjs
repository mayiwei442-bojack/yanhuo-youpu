...
export const chinese = [
  ...
  c("干煸四季豆", "Dry-fried Green Beans", "川菜", "四季豆450克；猪肉末100克；芽菜40克；干辣椒6个；花椒1茶匙；蒜末15克；生抽10毫升；盐适量", "1）四季豆去筋擦干，少油煸至表皮起皱且完全熟透。2）另锅炒酥肉末，加入芽菜、辣椒、花椒和蒜末。3）回锅四季豆，加生抽和盐翻匀。", "39-ganbian-sijidou.png"),
