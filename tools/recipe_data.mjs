...
export const chinese = [
  ...
  c("地三鲜", "Three Fresh Vegetables", "东北菜", "茄子300克；土豆250克；青椒120克；蒜末15克；生抽20毫升；糖5克；淀粉8克；盐2克", "1）茄子、土豆切滚刀块，青椒切片。2）土豆炸熟，茄子炸软，青椒快速过油。3）炒香蒜末，倒入酱油糖汁，回锅三样食材，勾薄芡。", "10-disanxian.png"),
  ...
  c("锅包肉", "Northeastern Sweet-and-sour Pork", "东北菜", "猪里脊350克；土豆淀粉120克；胡萝卜葱姜丝适量；白糖35克；白醋35毫升；生抽5毫升；盐2克", "1）里脊切大片，湿淀粉挂厚糊。2）油温六成炸定形，升温复炸至酥脆。3）锅中把糖醋汁熬至起泡，下肉片和配菜丝快速翻匀。", "34-guobaorou.png"),
  ...
  c("蒜蓉粉丝蒸扇贝", "Steamed Scallops with Garlic Vermicelli", "粤菜", "扇贝6只；龙口粉丝80克；蒜末50克；生抽20毫升；蚝油10克；糖2克；葱花和热油适量", "1）粉丝泡软剪段，扇贝洗净留半壳。2）一半蒜末炸香，与生蒜、生抽、蚝油和糖拌匀。3）壳上铺粉丝和贝肉，盖蒜酱，水开蒸5–6分钟，撒葱浇热油。", "37-suanrong-fensi-zheng-shanbei.png"),
  ...
  c("莲藕排骨汤", "Lotus Root Pork Rib Soup", "湖北", "排骨500克；莲藕600克；姜20克；料酒15毫升；盐适量；葱花少许", "1）排骨焯水，莲藕去皮切大块。2）排骨、莲藕和姜加足量热水，小火炖90分钟。3）加盐调味，撒葱花。", "46-lianou-paigu-tang.png", CN_HOME),
  ...
  c("豉汁蒸排骨", "Steamed Pork Ribs with Black Bean", "粤菜", "猪小排500克；豆豉20克；蒜末15克；生抽15毫升；蚝油10克；料酒10毫升；淀粉10克；糖3克", "1）排骨泡去血水并擦干。2）加入豆豉蒜末及所有调味料腌30分钟，平铺盘中。3）水开后大火蒸18–20分钟至熟。", "84-chizhi-zheng-paigu.png"),
