...
const artifacts = [
  ["cn-010", "cn-010-disanxian", "2026-08-30-cn-010-i10a", ["book", "website"]],
  ["cn-011", "cn-011-guilin-rice-noodles", "2026-09-07-cn-011-b20f", ["website"]],
  ["cn-024", "cn-024-guobaorou", "2026-08-30-cn-024-i10b", ["book", "website"]],
  ["cn-027", "cn-027-scallop-vermicelli", "2026-08-30-cn-027-i10c", ["book", "website"]],
  ["cn-036", "cn-036-lotus-rib-soup", "2026-08-30-cn-036-i10d", ["book", "website"]],
  ["cn-054", "cn-054-black-bean-ribs", "2026-08-30-cn-054-i10e", ["book", "website"]]
];

const results = [];
for (const [recipeId, slug, runId, expectedSourceTypes] of artifacts) {
  ...
  assert.deepEqual(new Set(evidence.sources.map((source) => source.sourceType)), new Set(expectedSourceTypes));
